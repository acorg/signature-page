...
namespace tree
{
    ...
    Tree tree_import(std::string aFilename);
    Tree tree_import(std::string aFilename, std::shared_ptr<acmacs::chart::Chart> chart, Tree::LadderizeMethod aLadderizeMethod = Tree::LadderizeMethod::NumberOfLeaves);
}
